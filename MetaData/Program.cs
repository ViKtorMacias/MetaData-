...
namespace MetaData__
{
    internal class Program
    {
        ...
        static string ifilesize(FileInfo fileInfo)
        {
            ...
            // Recorre cada archivo y carpeta y muestra su informacon de metadata
            foreach (FileInfo fileInfo in fileInfos)
            {
                Console.WriteLine("Nombre: " + fileInfo.Name);
                Console.WriteLine("Tamano: " + ifilesize(fileInfo));
                Console.WriteLine("Extension: " + fileInfo.Extension);
                Console.WriteLine("ultima modificacio: " + fileInfo.LastWriteTime);
        ...
        static void RecursiveDirectorySearch(DirectoryInfo directoryInfo)
        {
            ...
            // Recorre cada subdirectorio y llama a la funcion de forma recursiva
            foreach (DirectoryInfo subDirectory in subDirectories)
            {
                RecursiveDirectorySearch(subDirectory);
            }
